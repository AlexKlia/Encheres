...
<form action="<%=request.getContextPath()%>/ServletCreerCompte"
	...
	<div class="row mt-5">
		...
		<div class="col">
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" name="pseudo" id="pseudo" maxlength="30"  />
				</div>
			</div>
			<div class="form-group row">
				<label for="text" class="col-sm-4 col-form-label">Prénom : </label>
				<div class="col-sm-8">
					<input type="text" class="form-control" name="prenom" id="prenom" maxlength="30"/>
				</div>
			</div>
			<div class="form-group row">
				<label for="text" class="col-sm-4 col-form-label">Téléphone
					: </label>
				<div class="col-sm-8">
					<input type="tel" class="form-control" name="tel" id="tel" maxlength="15" />
				</div>
			</div>
			<div class="form-group row">
		...
		<div class="col">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" name="rue" id="rue" maxlength="30"/>
				</div>
			</div>
			<div class="form-group row">
				<label for="text" class="col-sm-4 col-form-label">Ville : </label>
				<div class="col-sm-8">
					<input type="text" class="form-control" name="ville" id="ville" maxlength="30"/>
				</div>
			</div>
			<div class="form-group row">
	...
	<div class="d-flex justify-content-center">
		<div class="row">
			...
			<div class="col">
			<button class="btn btn-outline-dark" type="submit" name="submitButton" value="add"
							>Créer</button>
			</div>
			<div class="col">
			<button class="btn btn-outline-dark" type="submit" name="submitButton" value="cancel"
							>Annuler</button>
			</div>
