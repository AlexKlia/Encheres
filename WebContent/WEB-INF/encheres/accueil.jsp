...
<form action="${request.getContextPath()}" method="GET">
	<div class="row">
		<div class="col col-sm-6">
			...
			<div class="form-group row">
				<label class="col-sm-auto col-form-label" for="categorie">Cat�gorie: </label>
				<div class="col-sm-6">
				...
				<div class="col-sm-6">
					<div class="form-check">
						...
						<div class="form-check">
							...
							<label class="form-check-label" for="encheresOuvertes">Ench�res ouvertes</label>
						</div>
						
						<div class="form-check">
							<input class="form-check-input" type="checkbox" name="achats" value="mesEncheresOuvertes" id="mesEncheresOuvertes">
							<label class="form-check-label" for="mesEncheresOuvertes">Mes ench�res en cours</label>
						</div>
				...
				<div class="col-sm-6">
					<div class="form-check">
						...
						<div class="form-check">
							...
							<label class="form-check-label" for="ventesNonDebutees">Ventes non debut�es</label>
						</div>
